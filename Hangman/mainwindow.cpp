...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    //setting up quit button and connecting it to the appropriate slots
...
void MainWindow::difficultyPressed() {
    ...
    if(button == ui->easyBut) {
        ui->textDisplay->setText("You have selected easy mode... are you sure you don't want to challenge yourself?");
